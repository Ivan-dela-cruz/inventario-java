...
public class Productos extends javax.swing.JInternalFrame {
    ...
    void cargar(String valor) {
        ...
        String mostrar = "SELECT * FROM productos WHERE CONCAT(codigo,nombre,descripcion,cantidad_inicial,stock,estado) LIKE '%" + valor + "%'";
    ...
    private void initComponents() {
        ...
        tb_productos.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                tb_productosKeyTyped(evt);
            }
        });
...
// TODO add your handling code here:
    try {
        Conexion j = new Conexion();
        j.conectar();
        j.editar("UPDATE productos SET nombre='" + txtnom.getText().toUpperCase()
...
// TODO add your handling code here:
    ...
    try {
        Conexion j = new Conexion();
        j.conectar();
        String sql = "INSERT INTO productos(codigo,nombre,descripcion,cantidad_inicial,stock,estado) VALUES('"
                + cod + "','"
                + nom + "','"
                + des + "','"
                + cantidad_ini + "','"
...
// TODO add your handling code here:
    ...
    String codigo = "";
    codigo = tb_productos.getValueAt(fila, 0).toString();
    if (fila >= 0) {
        try {
            Conexion j = new Conexion();
            j.conectar();
...
// "CÓDIGO", "CÉDULA", "NOMBRES", "APELLIDOS", "DIRECCIÓN", "TELEFONO", "PLACA", "MODELO", "COLOR"    
    ...
    btnguardar.setEnabled(false);
    int filamodificar = tb_productos.getSelectedRow();
    if (filamodificar >= 0) {
        txtcod.setText(tb_productos.getValueAt(filamodificar, 0).toString());
        txtnom.setText(tb_productos.getValueAt(filamodificar, 1).toString());
        txtdes.setText(tb_productos.getValueAt(filamodificar, 2).toString());
        spi_cantidad_inical.setValue(Integer.parseInt(tb_productos.getValueAt(filamodificar, 3).toString()));
        sp_stock.setValue(Integer.parseInt(tb_productos.getValueAt(filamodificar, 4).toString()));
        cboestado.setSelectedItem(tb_productos.getValueAt(filamodificar, 5).toString());
    ...
    private void tb_productosKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tb_productosKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_tb_productosKeyTyped
