...
import static views.EntradaMateriasPrimas.txtcodigo;
import static views.EntradaMateriasPrimas.txtnom;
import static views.EntradaMateriasPrimas.txtdes;
import static views.EntradaMateriasPrimas.txtstock;

import static views.MateriasPrima.s;
import static views.MateriasPrima.sql;

import static views.SalidaMateriasPrimas.txtnom_s;
import static views.SalidaMateriasPrimas.txtcodigo_s;
import static views.SalidaMateriasPrimas.txtdes_s;
import static views.SalidaMateriasPrimas.txtstock_s;

/**
 *
 * @author Administrador
 */
public class MateriasBuscar extends javax.swing.JInternalFrame {
    ...
    public MateriasBuscar(String ventana) {
        initComponents();
    ...
    void cargar(String valor) {
        ...
        String mostrar = "SELECT * FROM materias WHERE CONCAT(codigo,nombre,descripcion,stock) LIKE '%" + valor + "%' AND estado= 'ACTIVO'";
...
// TODO add your handling code here:
    ...
    try {
        if (fila == -1) {
            ...
            cod = (String) tb_materias.getValueAt(fila, 0);
            nom = (String) tb_materias.getValueAt(fila, 1);
            des = (String) tb_materias.getValueAt(fila, 2);
            stock = (String) tb_materias.getValueAt(fila, 3);
